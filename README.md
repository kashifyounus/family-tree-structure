...
| **web-build** | Postgres, Prisma migrate + seed, `next build` (artifact: `.next`) |
| **web-e2e** | Reuses build artifact, `next start`, Playwright E2E (HTML report uploaded on failure) |
